...
#define THRESHOLD_MAX       (4095)        // Maximum threshold value for microphone, expressed in ADC counts
#define THRESHOLD_BASE      (500)         // Default threshold value for microphone, expressed in ADC counts
...
#define PKT_TAIL1           (0x55)
#define PKT_TAIL2           (0xAA)
