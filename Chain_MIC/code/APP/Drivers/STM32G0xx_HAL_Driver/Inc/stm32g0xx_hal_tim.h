...
typedef struct {
    ...
    uint32_t BreakAFMode; /*!< Specifies the alternate function mode of the break input.This parameter can be a value of
                             @ref TIM_Break_Input_AF_Mode */
    ...
    uint32_t Break2Filter; /*!< TIM break2 input filter.This parameter can be a number between Min_Data = 0x0 and
                              Max_Data = 0xF */

    uint32_t Break2AFMode; /*!< Specifies the alternate function mode of the break2 input.This parameter can be a value
                              of @ref TIM_Break2_Input_AF_Mode */
...
#define TIM_TRGO2_OC1 \
    (TIM_CR2_MMS2_1 | TIM_CR2_MMS2_0)   /*!< Capture or a compare match 1 is used as trigger output (TRGO2) */
...
#define TIM_TRGO2_OC4REF_RISINGFALLING \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_1) /*!< OC4REF rising or falling edges generate pulses on TRGO2        */
#define TIM_TRGO2_OC6REF_RISINGFALLING \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_1 | TIM_CR2_MMS2_0) /*!< OC6REF rising or falling edges generate pulses on TRGO2 */
#define TIM_TRGO2_OC4REF_RISING_OC6REF_RISING \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2) /*!< OC4REF or OC6REF rising edges generate pulses on TRGO2         */
...
#define TIM_TRGO2_OC5REF_RISING_OC6REF_RISING \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 | TIM_CR2_MMS2_1) /*!< OC5REF or OC6REF rising edges generate pulses on TRGO2 */
...
#define TIM_BREAK_SYSTEM_ECC \
    SYSCFG_CFGR2_ECCL /*!< Enables and locks the ECC error signal with Break Input of TIM1/15/16/17 */
#define TIM_BREAK_SYSTEM_PVD                                                                                         \
    SYSCFG_CFGR2_PVDL /*!< Enables and locks the PVD connection with TIM1/15/16/17 Break Input and also the PVDE and \
                         PLS bits of the Power Control Interface */
#define TIM_BREAK_SYSTEM_SRAM_PARITY_ERROR \
    SYSCFG_CFGR2_SPL /*!< Enables and locks the SRAM_PARITY error signal with Break Input of TIM1/15/16/17 */
#define TIM_BREAK_SYSTEM_LOCKUP \
    SYSCFG_CFGR2_CLL /*!< Enables and locks the LOCKUP output of CortexM4 with Break Input of TIM1/15/16/17 */
/**
 * @}
 */
