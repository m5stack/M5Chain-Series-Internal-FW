...
static const uint32_t USART_PRESCALER_TAB[] = {1UL, 2UL, 4UL, 6UL, 8UL, 10UL, 12UL, 16UL, 32UL, 64UL, 128UL, 256UL};
/**
 * @}
 */
...
#define LL_USART_CR1_TXEIE_TXFNFIE \
    USART_CR1_TXEIE_TXFNFIE                   /*!< Transmit data register empty and TX FIFO not full interrupt enable */
...
#define LL_USART_BINARY_LOGIC_POSITIVE \
    0x00000000U /*!< Logical data from the data register are send/received in positive/direct logic. (1=H, 0=L) */
#define LL_USART_BINARY_LOGIC_NEGATIVE                                                                            \
    USART_CR2_DATAINV /*!< Logical data from the data register are send/received in negative/inverse logic. (1=L, \
...
#define LL_USART_BITORDER_LSBFIRST \
    0x00000000U /*!< data is transmitted/received with data bit 0 first, following the start bit */
#define LL_USART_BITORDER_MSBFIRST \
    USART_CR2_MSBFIRST /*!< data is transmitted/received with the MSB first, following the start bit */
/**
 * @}
 */
...
#define LL_USART_AUTOBAUD_DETECT_ON_FALLINGEDGE                                                                        \
    USART_CR2_ABRMODE_0 /*!< Falling edge to falling edge measurement. Received frame must start with a single bit = 1 \
                           -> Frame = Start10xxxxxx */
