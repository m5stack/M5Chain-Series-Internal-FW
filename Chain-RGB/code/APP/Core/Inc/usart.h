...
// DMA receive buffers
extern __IO uint8_t g_uart_in_rx_buf[UART_BUFFER_SIZE][BUFFER_SIZE];   // uart_in data buffer for
                                                                       // receiving data via DMA
extern __IO uint8_t g_uart_out_rx_buf[UART_BUFFER_SIZE][BUFFER_SIZE];  // uart_out data buffer
...
extern __IO uint8_t g_uart_in_transmit_complete;   // Serial 1 transmission complete flag
extern __IO uint8_t g_uart_out_transmit_complete;  // Serial 2 transmission complete flag
