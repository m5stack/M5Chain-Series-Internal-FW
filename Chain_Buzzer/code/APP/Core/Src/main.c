        ...
        if (g_cmd_status == CMD_SPACE_BUSY_STATUS) {
            switch (g_cmd_buf[0]) {
                ...
                case CHAIN_GET_RGB_LIGHT:
                    ...
                    break;
                case CHAIN_BUZZER_SET_MODE:
                    chain_buzzer_set_mode((uint8_t *)(g_cmd_buf + 1), (g_cmd_size - 1));
                    break;
                case CHAIN_BUZZER_GET_MODE:
                    chain_buzzer_get_mode();
                    break;
                case CHAIN_BUZZER_SET_AUTO_PLAY:
                    chain_buzzer_set_auto_play((uint8_t *)(g_cmd_buf + 1), (g_cmd_size - 1));
                    break;
                case CHAIN_BUZZER_SET_NOTE_PLAY:
                    chain_buzzer_set_note_play((uint8_t *)(g_cmd_buf + 1), (g_cmd_size - 1));
                    break;
                case CHAIN_BUZZER_SET_FREQ:
                    chain_buzzer_set_freq((uint8_t *)(g_cmd_buf + 1), (g_cmd_size - 1));
                    break;
                case CHAIN_BUZZER_GET_FREQ:
                    chain_buzzer_get_freq();
                    break;
                case CHAIN_BUZZER_SET_DUTY:
                    chain_buzzer_set_duty((uint8_t *)(g_cmd_buf + 1), (g_cmd_size - 1));
                    break;
                case CHAIN_BUZZER_GET_DUTY:
                    chain_buzzer_get_duty();
                    break;
                case CHAIN_BUZZER_SET_STATUS:
                    chain_buzzer_set_status((uint8_t *)(g_cmd_buf + 1), (g_cmd_size - 1));
                    break;
                case CHAIN_BUZZER_GET_STATUS:
                    chain_buzzer_get_status();
                    break;
                case CHAIN_GET_UID:
