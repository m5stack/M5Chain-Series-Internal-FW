...
#define LED_PA1_Pin GPIO_PIN_1
#define LED_PA1_GPIO_Port GPIOA
...
#define LED_PA11_Pin GPIO_PIN_11
#define LED_PA11_GPIO_Port GPIOA
#define LED_PA12_Pin GPIO_PIN_12
#define LED_PA12_GPIO_Port GPIOA
...
#define SCREEN_ROTATION_BASE (0)           // Default screen rotation value (0 = default orientation)
#define RRIGTNESS_LEVEL_BASE (7)           // Default brightness level for screen, expressed as a level value (7)
