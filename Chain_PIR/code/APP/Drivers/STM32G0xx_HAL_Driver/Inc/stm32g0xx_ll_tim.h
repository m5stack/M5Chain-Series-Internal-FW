...
#define LL_TIM_TRGO2_CC1F \
    (TIM_CR2_MMS2_1 | TIM_CR2_MMS2_0)   /*!< CC1 capture or a compare match is used as trigger output 2 */
...
#define LL_TIM_TRGO2_OC4_RISINGFALLING \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_1) /*!< OC4REF rising or falling edges are used as trigger output 2 */
...
#define LL_TIM_TRGO2_OC4_RISING_OC6_RISING \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2) /*!< OC4REF or OC6REF rising edges are used as trigger output 2 */
...
#define LL_TIM_SLAVEMODE_COMBINED_RESETTRIGGER                                                                         \
    TIM_SMCR_SMS_3 /*!< Combined reset + trigger mode - Rising edge of the selected trigger input (TRGI) reinitializes \
...
#define LL_TIM_ETRSOURCE_ADC1_AWD1 \
    (TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_0)          /*!< ETR input is connected to ADC1 analog watchdog 1 */
...
#define LL_TIM_ETRSOURCE_ADC1_AWD3 \
    (TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_0) /*!< ETR input is connected to ADC1 analog watchdog 3 */
...
#define LL_TIM_DMABURST_BASEADDR_OR1 \
    (TIM_DCR_DBA_4 | TIM_DCR_DBA_2) /*!< TIMx_OR1 register is the DMA base address for DMA burst */
#define LL_TIM_DMABURST_BASEADDR_CCMR3 \
    (TIM_DCR_DBA_4 | TIM_DCR_DBA_2 | TIM_DCR_DBA_0) /*!< TIMx_CCMR3 register is the DMA base address for DMA burst */
#define LL_TIM_DMABURST_BASEADDR_CCR5 \
    (TIM_DCR_DBA_4 | TIM_DCR_DBA_2 | TIM_DCR_DBA_1) /*!< TIMx_CCR5 register is the DMA base address for DMA burst */
...
#define LL_TIM_DMABURST_BASEADDR_AF1 \
    (TIM_DCR_DBA_4 | TIM_DCR_DBA_3) /*!< TIMx_AF1 register is the DMA base address for DMA burst */
#define LL_TIM_DMABURST_BASEADDR_AF2 \
    (TIM_DCR_DBA_4 | TIM_DCR_DBA_3 | TIM_DCR_DBA_0) /*!< TIMx_AF2 register is the DMA base address for DMA burst */
#define LL_TIM_DMABURST_BASEADDR_TISEL \
    (TIM_DCR_DBA_4 | TIM_DCR_DBA_3 | TIM_DCR_DBA_1) /*!< TIMx_TISEL register is the DMA base address for DMA burst */
/**
 * @}
 */
