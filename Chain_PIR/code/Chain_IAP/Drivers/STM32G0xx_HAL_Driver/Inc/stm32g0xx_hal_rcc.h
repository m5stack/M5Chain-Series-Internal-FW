...
#if defined(RCC_HSI48_SUPPORT)
    uint32_t HSI48State; /*!< The new state of the HSI48 (only applicable to STM32G0C1xx/STM32G0B1xx/STM32G0B0xx
                            devices). This parameter can be a value of @ref RCC_HSI48_Config */
...
#define RCC_MCO_PA8                                                                                            \
    (RCC_MCO1_INDEX | (GPIO_AF0_MCO << RCC_MCO_GPIOAF_POS) | (GPIO_GET_INDEX(GPIOA) << RCC_MCO_GPIOPORT_POS) | \
     GPIO_PIN_8)
#define RCC_MCO_PA9                                                                                            \
    (RCC_MCO1_INDEX | (GPIO_AF0_MCO << RCC_MCO_GPIOAF_POS) | (GPIO_GET_INDEX(GPIOA) << RCC_MCO_GPIOPORT_POS) | \
     GPIO_PIN_9)
#define RCC_MCO_PD10                                                                                           \
    (RCC_MCO1_INDEX | (GPIO_AF0_MCO << RCC_MCO_GPIOAF_POS) | (GPIO_GET_INDEX(GPIOD) << RCC_MCO_GPIOPORT_POS) | \
     GPIO_PIN_10) /* Not defined for all stm32g0xx family lines */
#define RCC_MCO_PF2                                                                                            \
    (RCC_MCO1_INDEX | (GPIO_AF0_MCO << RCC_MCO_GPIOAF_POS) | (GPIO_GET_INDEX(GPIOF) << RCC_MCO_GPIOPORT_POS) | \
