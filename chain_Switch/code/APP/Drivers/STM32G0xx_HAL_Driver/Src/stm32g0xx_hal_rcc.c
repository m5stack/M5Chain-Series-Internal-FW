 ...
 ===============================================================================
    ...
    [..] Internal/external clock and PLL configuration
         ...
         (+) MCOx (microcontroller clock output):
             (++) MCO1 used to output LSI, HSI48(*), HSI, LSE, HSE or main PLL clock (through a configurable prescaler)
 on PA8 pin.
             (++) MCO2(*) used to output LSI, HSI48(*), HSI, LSE, HSE, main PLLR clock, PLLQ clock, PLLP clock, RTC
 clock or RTC_Wakeup (through a configurable prescaler) on PA10 pin.
