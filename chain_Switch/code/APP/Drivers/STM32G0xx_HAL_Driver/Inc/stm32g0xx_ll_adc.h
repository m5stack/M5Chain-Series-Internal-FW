...
#define ADC_REG_TRIG_EDGE_MASK                                                                                        \
    (((LL_ADC_REG_TRIG_SOFTWARE & ADC_CFGR1_EXTEN) << (4U * 0UL)) | ((ADC_REG_TRIG_EXT_EDGE_DEFAULT) << (4U * 1UL)) | \
...
#define ADC_CHANNEL_ID_NUMBER_MASK_SEQ                                                            \
    (ADC_CHSELR_SQ1 << ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS) /* Equivalent to                      \
...
#define ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS                       \
    (26UL) /* Equivalent to bitfield "ADC_CHANNEL_ID_NUMBER_MASK" \
...
#define ADC_CHANNEL_ID_NUMBER_MASK_POSBIT0                          \
    (0x0000001FUL) /* Equivalent to shift: (ADC_CHANNEL_NUMBER_MASK \
...
#define ADC_AWD_TRX_BIT_HIGH_SHIFT4                                          \
    (ADC_AWD_TRX_BIT_HIGH_POS - 4UL) /* Shift of bit ADC_AWD_TRX_BIT_HIGH to \
...
#define ADC_CR_BITS_PROPERTY_RS                                                                              \
    (ADC_CR_ADCAL | ADC_CR_ADEN | ADC_CR_ADDIS | ADC_CR_ADSTART | ADC_CR_ADSTP) /* ADC register CR bits with \
...
#define LL_ADC_CLOCK_ASYNC_DIV16                                                                  \
    (ADC_CCR_PRESC_2 | ADC_CCR_PRESC_1 | ADC_CCR_PRESC_0) /*!< ADC asynchronous clock with        \
...
#define LL_ADC_CLOCK_ASYNC_DIV256                                                                 \
    (ADC_CCR_PRESC_3 | ADC_CCR_PRESC_1 | ADC_CCR_PRESC_0) /*!< ADC asynchronous clock with        \
 ...
 * @{
 */
#define LL_ADC_CLOCK_FREQ_MODE_HIGH                       \
    (0x00000000UL) /*!< ADC clock mode to high frequency. \
On STM32G0, ADC clock frequency above 3.5MHz.  */
#define LL_ADC_CLOCK_FREQ_MODE_LOW                        \
    (ADC_CCR_LFMEN) /*!< ADC clock mode to low frequency. \
...
#define LL_ADC_PATH_INTERNAL_TEMPSENSOR                                                          \
    (ADC_CCR_TSEN)                                 /*!< ADC measurement path to internal channel \
                                                        temperature sensor */
...
#define LL_ADC_CLOCK_SYNC_PCLK_DIV4                                        \
    (ADC_CFGR2_CKMODE_1) /*!< ADC synchronous clock derived from AHB clock \
    divided by 4 */
...
#define LL_ADC_CLOCK_SYNC_PCLK_DIV1                                                             \
    (ADC_CFGR2_CKMODE_1 | ADC_CFGR2_CKMODE_0) /*!< ADC synchronous clock derived from AHB clock \
                       not divided */
#define LL_ADC_CLOCK_ASYNC                                         \
    (0x00000000UL) /*!< ADC asynchronous clock. Asynchronous clock \
...
#define LL_ADC_DATA_ALIGN_LEFT                                         \
    (ADC_CFGR1_ALIGN) /*!< ADC conversion data alignment: left aligned \
...
#define LL_ADC_LP_AUTOWAIT                                                 \
    (ADC_CFGR1_WAIT) /*!< ADC low power mode auto delay: Dynamic low power \
...
#define LL_ADC_LP_AUTOPOWEROFF                                                 \
    (ADC_CFGR1_AUTOFF) /*!< ADC low power mode auto power-off: the ADC         \
...
#define LL_ADC_LP_AUTOWAIT_AUTOPOWEROFF                                    \
    (ADC_CFGR1_WAIT | ADC_CFGR1_AUTOFF) /*!< ADC low power modes auto wait \
...
#define LL_ADC_TRIGGER_FREQ_LOW                                                   \
    (ADC_CFGR2_LFTRIG) /*!< ADC trigger frequency mode set to low frequency.      \
    Note: ADC trigger frequency mode must be set to low frequency when a duration \
    is exceeded before ADC conversion start trigger event (between ADC enable     \
    and ADC conversion start trigger event or between two ADC conversion start    \
    trigger event).                                                               \
...
#define LL_ADC_SAMPLINGTIME_COMMON_1                                       \
    (ADC_SMPR_SMP1_BITOFFSET_POS) /*!< Set sampling time common to a group \
    of channels: sampling time nb 1 */
#define LL_ADC_SAMPLINGTIME_COMMON_2                                                                   \
    (ADC_SMPR_SMP2_BITOFFSET_POS | ADC_SAMPLING_TIME_CH_MASK) /*!< Set sampling time common to a group \
...
#define LL_ADC_CHANNEL_TEMPSENSOR                                              \
    (LL_ADC_CHANNEL_12 | ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel \
   connected to Temperature sensor. */
#define LL_ADC_CHANNEL_VBAT                                                    \
    (LL_ADC_CHANNEL_14 | ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel \
...
#define LL_ADC_REG_TRIG_EXT_TIM3_TRGO                                                                \
    (ADC_CFGR1_EXTSEL_1 | ADC_CFGR1_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular \
                        conversion trigger from external peripheral: TIM3 TRGO.                      \
                        Trigger edge set to rising edge (default setting). */
#if defined(TIM4)
#define LL_ADC_REG_TRIG_EXT_TIM4_TRGO                                                                \
    (ADC_CFGR1_EXTSEL_2 | ADC_CFGR1_EXTSEL_1 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular \
                        conversion trigger from external peripheral: TIM4 TRGO.                      \
                        Trigger edge set to rising edge (default setting). */
#endif                                                                        /* TIM4 */
#if defined(TIM6)
#define LL_ADC_REG_TRIG_EXT_TIM6_TRGO                                                                \
    (ADC_CFGR1_EXTSEL_2 | ADC_CFGR1_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular \
                        conversion trigger from external peripheral: TIM6 TRGO.                      \
                        Trigger edge set to rising edge (default setting). */
#endif                                                                        /* TIM6 */
#if defined(TIM15)
#define LL_ADC_REG_TRIG_EXT_TIM15_TRGO                                          \
    (ADC_CFGR1_EXTSEL_2 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular \
   conversion trigger from external peripheral: TIM15 TRGO.                     \
   Trigger edge set to rising edge (default setting). */
#endif                                                   /* TIM15 */
#define LL_ADC_REG_TRIG_EXT_EXTI_LINE11                                                                              \
    (ADC_CFGR1_EXTSEL_2 | ADC_CFGR1_EXTSEL_1 | ADC_CFGR1_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group    \
                                             regular conversion trigger from external peripheral: external interrupt \
                                             line 11. Trigger edge set to rising edge (default setting). */
/**
 * @}
 */
...
#define LL_ADC_REG_TRIG_EXT_RISING                        \
    (ADC_CFGR1_EXTEN_0) /*!< ADC group regular conversion \
trigger polarity set to rising edge */
#define LL_ADC_REG_TRIG_EXT_FALLING                       \
    (ADC_CFGR1_EXTEN_1) /*!< ADC group regular conversion \
trigger polarity set to falling edge */
#define LL_ADC_REG_TRIG_EXT_RISINGFALLING                                     \
    (ADC_CFGR1_EXTEN_1 | ADC_CFGR1_EXTEN_0) /*!< ADC group regular conversion \
...
#define LL_ADC_REG_CONV_CONTINUOUS                                      \
    (ADC_CFGR1_CONT) /*!< ADC conversions performed in continuous mode: \
...
#define LL_ADC_REG_DMA_TRANSFER_LIMITED                                    \
    (ADC_CFGR1_DMAEN) /*!< ADC conversion data are transferred by DMA,     \
...
#define LL_ADC_REG_DMA_TRANSFER_UNLIMITED                                      \
    (ADC_CFGR1_DMACFG | ADC_CFGR1_DMAEN) /*!< ADC conversion data are          \
...
#define LL_ADC_REG_SEQ_CONFIGURABLE                                           \
    (ADC_CFGR1_CHSELRMOD) /*!< Sequencer configured to fully configurable:    \
...
#define LL_ADC_REG_SEQ_SCAN_DIR_FORWARD                                      \
    (0x00000000UL) /*!< On this STM32 series, parameter relevant only if     \
...
#define LL_ADC_REG_SEQ_SCAN_DIR_BACKWARD                                         \
    (ADC_CFGR1_SCANDIR) /*!< On this STM32 series, parameter relevant only if    \
    sequencer set to mode not fully configurable, refer to function              \
    @ref LL_ADC_REG_SetSequencerConfigurable(). ADC group regular sequencer scan \
...
#define LL_ADC_SAMPLINGTIME_160CYCLES_5 \
    (ADC_SMPR_SMP1_2 | ADC_SMPR_SMP1_1 | ADC_SMPR_SMP1_0) /*!< Sampling time 160.5 ADC clock cycles */
/**
 * @}
 */
...
#define LL_ADC_AWD_ALL_CHANNELS_REG                                                    \
    (ADC_AWD_CR23_CHANNEL_MASK | ADC_CFGR1_AWD1EN) /*!< ADC analog watchdog monitoring \
          of all channels, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_0_REG                                                                               \
    ((LL_ADC_CHANNEL_0 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN0, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_1_REG                                                                               \
    ((LL_ADC_CHANNEL_1 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN1, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_2_REG                                                                               \
    ((LL_ADC_CHANNEL_2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN2, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_3_REG                                                                               \
    ((LL_ADC_CHANNEL_3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN3, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_4_REG                                                                               \
    ((LL_ADC_CHANNEL_4 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN4, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_5_REG                                                                               \
    ((LL_ADC_CHANNEL_5 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN5, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_6_REG                                                                               \
    ((LL_ADC_CHANNEL_6 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN6, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_7_REG                                                                               \
    ((LL_ADC_CHANNEL_7 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN7, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_8_REG                                                                               \
    ((LL_ADC_CHANNEL_8 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN8, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_9_REG                                                                               \
    ((LL_ADC_CHANNEL_9 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN9, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_10_REG                                                                               \
    ((LL_ADC_CHANNEL_10 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                             monitoring of ADC channel ADCx_IN10, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_11_REG                                                                               \
    ((LL_ADC_CHANNEL_11 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                             monitoring of ADC channel ADCx_IN11, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_12_REG                                                                               \
    ((LL_ADC_CHANNEL_12 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                             monitoring of ADC channel ADCx_IN12, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_13_REG                                                                               \
    ((LL_ADC_CHANNEL_13 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                             monitoring of ADC channel ADCx_IN13, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_14_REG                                                                               \
    ((LL_ADC_CHANNEL_14 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                             monitoring of ADC channel ADCx_IN14, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_15_REG                                                                               \
    ((LL_ADC_CHANNEL_15 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                             monitoring of ADC channel ADCx_IN15, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_16_REG                                                                               \
    ((LL_ADC_CHANNEL_16 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                              monitoring of ADC channel ADCx_IN16, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_17_REG                                                                               \
    ((LL_ADC_CHANNEL_17 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                              monitoring of ADC channel ADCx_IN17, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_18_REG                                                                               \
    ((LL_ADC_CHANNEL_18 & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                              monitoring of ADC channel ADCx_IN18, converted by group regular only */
#define LL_ADC_AWD_CH_VREFINT_REG                                                                                    \
    ((LL_ADC_CHANNEL_VREFINT & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog watchdog \
                                                   monitoring of ADC internal channel connected to VrefInt: Internal \
                                                   voltage reference, converted by group regular only */
#define LL_ADC_AWD_CH_TEMPSENSOR_REG                                                                           \
    ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL) /*!< ADC analog \
                                                      watchdog monitoring of ADC internal channel connected to \
                                                      internal temperature sensor, converted by group regular only */
...
#define LL_ADC_AWD_THRESHOLDS_HIGH_LOW                                                      \
    (ADC_AWD1TR_HT1 | ADC_AWD1TR_LT1) /*!< ADC analog watchdog both thresholds high and low \
...
#define LL_ADC_OVS_GRP_REGULAR_CONTINUED                                  \
    (ADC_CFGR2_OVSE) /*!< ADC oversampling on conversions of              \
...
#define LL_ADC_OVS_REG_DISCONT                                               \
    (ADC_CFGR2_TOVS) /*!< ADC oversampling discontinuous mode: discontinuous \
...
#define LL_ADC_OVS_RATIO_256                                                                      \
    (ADC_CFGR2_OVSR_2 | ADC_CFGR2_OVSR_1 | ADC_CFGR2_OVSR_0) /*!< ADC oversampling ratio of 256   \
                      (sum of conversions data computed to result as oversampling conversion data \
                      (before potential shift) */
/**
 * @}
...
#define LL_ADC_OVS_SHIFT_RIGHT_7                                                                    \
    (ADC_CFGR2_OVSS_2 | ADC_CFGR2_OVSS_1 | ADC_CFGR2_OVSS_0) /*!< ADC oversampling right shift of 7 \
...
#define LL_ADC_DELAY_CALIB_ENABLE_ADC_CYCLES                 \
    (2UL) /*!< Delay required between ADC end of calibration \
               and ADC enable */
...
#define __LL_ADC_CHANNEL_TO_DECIMAL_NB(__CHANNEL__)                                                                                                                     \
    ((((__CHANNEL__) & ADC_CHANNEL_ID_BITFIELD_MASK) == 0UL)                                                                                                            \
         ...
         : ((((__CHANNEL__) & ADC_CHANNEL_0_BITFIELD) == ADC_CHANNEL_0_BITFIELD)                                                                                        \
                ? (0UL)                                                                                                                                                 \
                : ((((__CHANNEL__) & ADC_CHANNEL_1_BITFIELD) == ADC_CHANNEL_1_BITFIELD)                                                                                 \
                       ? (1UL)                                                                                                                                          \
                       : ((((__CHANNEL__) & ADC_CHANNEL_2_BITFIELD) == ADC_CHANNEL_2_BITFIELD)                                                                          \
                              ? (2UL)                                                                                                                                   \
                              : ((((__CHANNEL__) & ADC_CHANNEL_3_BITFIELD) == ADC_CHANNEL_3_BITFIELD)                                                                   \
                                     ? (3UL)                                                                                                                            \
                                     : ((((__CHANNEL__) & ADC_CHANNEL_4_BITFIELD) == ADC_CHANNEL_4_BITFIELD)                                                            \
                                            ? (4UL)                                                                                                                     \
                                            : ((((__CHANNEL__) & ADC_CHANNEL_5_BITFIELD) == ADC_CHANNEL_5_BITFIELD)                                                     \
                                                   ? (5UL)                                                                                                              \
                                                   : ((((__CHANNEL__) & ADC_CHANNEL_6_BITFIELD) ==                                                                      \
                                                       ADC_CHANNEL_6_BITFIELD)                                                                                          \
                                                          ? (6UL)                                                                                                       \
                                                          : ((((__CHANNEL__) & ADC_CHANNEL_7_BITFIELD) ==                                                               \
                                                              ADC_CHANNEL_7_BITFIELD)                                                                                   \
                                                                 ? (7UL)                                                                                                \
                                                                 : ((((__CHANNEL__) & ADC_CHANNEL_8_BITFIELD) ==                                                        \
...
#define __LL_ADC_DECIMAL_NB_TO_CHANNEL(__DECIMAL_NB__) \
    (((__DECIMAL_NB__) << ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS) | (ADC_CHSELR_CHSEL0 << (__DECIMAL_NB__)))
...
#define __LL_ADC_CONVERT_DATA_RESOLUTION(__DATA__, __ADC_RESOLUTION_CURRENT__, __ADC_RESOLUTION_TARGET__) \
    (((__DATA__) << ((__ADC_RESOLUTION_CURRENT__) >> (ADC_CFGR1_RES_BITOFFSET_POS - 1UL))) >>             \
...
__STATIC_INLINE void LL_ADC_SetAnalogWDMonitChannels(ADC_TypeDef *ADCx, uint32_t AWDy, uint32_t AWDChannelGroup)
{
    ...
    if (AWDy == LL_ADC_AWD1) {
        ...
        preg = __ADC_PTR_REG_OFFSET(
            ADCx->AWD2CR, ((AWDy & ADC_AWD_CRX_REGOFFSET_MASK)) >> (ADC_AWD_CRX_REGOFFSET_BITOFFSET_POS + 1UL));
    }
...
{
    __IO const uint32_t *preg = __ADC_PTR_REG_OFFSET(
        ADCx->CFGR1, ((AWDy & ADC_AWD_CRX_REGOFFSET_MASK) >> ADC_AWD_CRX_REGOFFSET_POS) +
        ...
        if (AWDy == LL_ADC_AWD1) {
            if ((analog_wd_monit_channels & ADC_CFGR1_AWD1SGL) == 0UL) {
                ...
                analog_wd_monit_channels =
                    ((analog_wd_monit_channels | (ADC_AWD_CR23_CHANNEL_MASK)) & (~(ADC_CFGR1_AWD1CH)));
            } else {
            ...
            if ((analog_wd_monit_channels & ADC_AWD_CR23_CHANNEL_MASK) == ADC_AWD_CR23_CHANNEL_MASK) {
                /* AWD monitoring a group of channels */
                analog_wd_monit_channels = (ADC_AWD_CR23_CHANNEL_MASK | (ADC_CFGR1_AWD1EN));
            } else {
                /* AWD monitoring a single channel */
                /* AWD monitoring a group of channels */
                analog_wd_monit_channels =
                                                     ...
                                                     uint32_t AWDThresholdLowValue)
{
    ...
    __IO uint32_t *preg = __ADC_PTR_REG_OFFSET(
        ADCx->AWD1TR, (((AWDy & ADC_AWD_TRX_REGOFFSET_MASK)) >> (ADC_AWD_TRX_REGOFFSET_BITOFFSET_POS)) +
