...
#define IS_LL_UTILS_HSI_DIV(__VALUE__)                                                                                \
    (((__VALUE__) == LL_RCC_HSI_DIV_1) || ((__VALUE__) == LL_RCC_HSI_DIV_2) || ((__VALUE__) == LL_RCC_HSI_DIV_4) ||   \
     ((__VALUE__) == LL_RCC_HSI_DIV_8) || ((__VALUE__) == LL_RCC_HSI_DIV_16) || ((__VALUE__) == LL_RCC_HSI_DIV_32) || \
     ((__VALUE__) == LL_RCC_HSI_DIV_64) || ((__VALUE__) == LL_RCC_HSI_DIV_128))

#define IS_LL_UTILS_PLLM_VALUE(__VALUE__)                                                                              \
    (((__VALUE__) == LL_RCC_PLLM_DIV_1) || ((__VALUE__) == LL_RCC_PLLM_DIV_2) || ((__VALUE__) == LL_RCC_PLLM_DIV_3) || \
     ((__VALUE__) == LL_RCC_PLLM_DIV_4) || ((__VALUE__) == LL_RCC_PLLM_DIV_5) || ((__VALUE__) == LL_RCC_PLLM_DIV_6) || \
     ((__VALUE__) == LL_RCC_PLLM_DIV_7) || ((__VALUE__) == LL_RCC_PLLM_DIV_8))

#define IS_LL_UTILS_PLLN_VALUE(__VALUE__) ((8U <= (__VALUE__)) && ((__VALUE__) <= 86U))

#define IS_LL_UTILS_PLLR_VALUE(__VALUE__)                                                                              \
    (((__VALUE__) == LL_RCC_PLLR_DIV_2) || ((__VALUE__) == LL_RCC_PLLR_DIV_3) || ((__VALUE__) == LL_RCC_PLLR_DIV_4) || \
     ((__VALUE__) == LL_RCC_PLLR_DIV_5) || ((__VALUE__) == LL_RCC_PLLR_DIV_6) || ((__VALUE__) == LL_RCC_PLLR_DIV_7) || \
     ((__VALUE__) == LL_RCC_PLLR_DIV_8))

#define IS_LL_UTILS_PLLVCO_INPUT(__VALUE__) \
    ((UTILS_PLLVCO_INPUT_MIN <= (__VALUE__)) && ((__VALUE__) <= UTILS_PLLVCO_INPUT_MAX))

#define IS_LL_UTILS_PLLVCO_OUTPUT(__VALUE__) \
    ((UTILS_PLLVCO_OUTPUT_MIN <= (__VALUE__)) && ((__VALUE__) <= UTILS_PLLVCO_OUTPUT_MAX))
